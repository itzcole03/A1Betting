...
export declare class FinalPredictionEngineImpl implements FinalPredictionEngine {
    ...
    constructor(dependencies: FinalPredictionEngineDependencies, initialConfig: FinalPredictionEngineConfig);
    generatePrediction(modelOutputs: ModelOutput[], riskProfile: RiskProfile, context?: Record<string, any>): Promise<FinalPrediction>;
    ...
    generatePredictionWithExplanation(features: Record<string, number>, riskLevel?: RiskLevel): Promise<PredictionWithExplanation>;
}
