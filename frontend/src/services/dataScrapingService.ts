 ...
 * }
 */
export const fetchDailyFantasyProjections = async (
  date: string,
  league?: string,
 ...
 * }
 */
export const triggerScrapingJob = async (
  job_type: string,
  league?: string,
  target_date?: string,
...
const mapBackendDFPToFrontend = (
  backendItem: BackendDFPResponseItem,
): DailyFantasyProjection => {
  return {
