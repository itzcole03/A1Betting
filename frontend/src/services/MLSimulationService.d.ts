...
import type { Prediction, TeamStats, PlayerStats, PlayerForm, InjuryStatus } from '../types/betting';
import type { BetSimulationInput, BetSimulationResult } from '../types/simulation';
import type { PredictionWithConfidence, PerformanceHistory } from '../types/confidence';
export declare class MLSimulationService extends EventEmitter {
     ...
     */
    getPredictionWithConfidence(gameId: string, playerId: string, metric: keyof PlayerStats): PredictionWithConfidence;
    /**
