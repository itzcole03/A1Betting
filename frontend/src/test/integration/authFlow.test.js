...
jest.mock('framer-motion', () => {
    ...
    const motion = new Proxy({}, {
        get: () => React.forwardRef((props, ref) => React.createElement('div', { ...props, ref })),
    });
    return {
        __esModule: true,
        motion,
        AnimatePresence: React.forwardRef((props, ref) => React.createElement('div', { ...props, ref })),
        AnimateSharedLayout: React.forwardRef((props, ref) => React.createElement('div', { ...props, ref })),
        LayoutGroup: React.forwardRef((props, ref) => React.createElement('div', { ...props, ref })),
        LazyMotion: React.forwardRef((props, ref) => React.createElement('div', { ...props, ref })),
        m: new Proxy({}, {
            get: () => React.forwardRef((props, ref) => React.createElement('div', { ...props, ref })),
        }),
    };
...
describe('Authentication Flow Integration Test', () => {
    ...
    it('should display an error message on failed login', async () => {
        ...
        await waitFor(() => {
            ...
            else if (typeof storeError === 'string' &&
