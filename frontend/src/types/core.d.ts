import { Sport, PropType, AlertType, AlertSeverity, EntryStatus, LineupType } from './common.js';
/**
...
export interface EventMap {
     ...
     */
    'game:status': {
        game: import('../services/ESPNService.js').ESPNGame;
        timestamp: number;
    };
    /**
     ...
     */
    'player:update': {
        player: import('../services/ESPNService.js').ESPNPlayer;
        timestamp: number;
    };
    /**
     ...
     */
    'news:update': {
        headlines: import('../types.js').ESPNHeadline[];
        timestamp: number;
    };
    /**
...
export type ErrorCategory = 'SYSTEM' | 'VALIDATION' | 'NETWORK' | 'AUTH' | 'BUSINESS' | 'DATABASE' | 'CONFIGURATION' | 'MODEL';
