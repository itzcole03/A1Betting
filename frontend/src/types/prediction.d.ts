...
export interface ModelPrediction extends Omit<Prediction, 'id' | 'eventName' | 'sport' | 'betType' | 'odds' | 'recommendedStake' | 'riskLevel' | 'shapValues' | 'modelWeights' | 'features' | 'metadata'> {
    modelName: string;
    prediction: number;
    features: Feature[];
    lastUpdated: Date;
