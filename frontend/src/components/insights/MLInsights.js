...
const MLInsights = () => {
    ...
    if (error)
        return (_jsxs("div", { className: "p-6 glass rounded-xl bg-red-500/10 text-red-400 flex items-center animate-fade-in", children: [_jsx(AlertTriangle, { className: "mr-2", size: 20 }), " Error: ", error] }));
