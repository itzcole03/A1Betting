    ...
    onMouseEnter: (e) => {
      if (!disabled && !loading) {
        if (variant === "primary" || variant === "success") {
          ...
          e.target.style.borderColor = CYBER_COLORS.primary;
        }
      }
    },
    onMouseLeave: (e) => {
      if (!disabled && !loading) {
        ...
        e.target.style.boxShadow = getVariantStyle().boxShadow || "none";
        if (variant === "secondary") {
          e.target.style.backgroundColor = getVariantStyle().backgroundColor;
          e.target.style.borderColor =
            getVariantStyle().border?.split("1px solid ")[1] ||
            "rgba(255, 255, 255, 0.1)";
        } else if (variant === "ghost") {
          e.target.style.backgroundColor = "rgba(255, 255, 255, 0.05)";
          e.target.style.borderColor = `${CYBER_COLORS.primary}80`;
        }
      }
    },
    children: [
      ...
      icon && iconPosition === "left" && _jsx("span", { children: icon }),
      _jsx("span", { children: children }),
      icon && iconPosition === "right" && _jsx("span", { children: icon }),
    ],
  });
};
// ============================================================================
        ...
        _jsx("div", {
          ...
          children: _jsxs("div", {
            ...
            children: [
              ...
              headerActions && _jsx("div", { children: headerActions }),
            ],
          }),
        }),
      children &&
