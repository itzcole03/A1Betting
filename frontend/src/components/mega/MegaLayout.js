...
export const MegaSidebar = ({
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        style: { padding: isCompact ? "16px 12px" : "20px" },
        children: [
          _jsxs("div", {
            style: {
              display: "flex",
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx("div", {
                    ...
                    children: _jsx(Brain, { size: 24, color: "#000" }),
                  }),
                  !isCompact &&
                    _jsxs("div", {
                      children: [
              ...
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    _jsx("div", {
                      ...
                      children: _jsx(User, { size: 16, color: "#000" }),
                    }),
                    _jsxs("div", {
                      children: [
                        _jsx(CyberText, {
                ...
                user.balance &&
                  _jsxs(CyberText, {
                    variant: "caption",
                    color: "accent",
                    children: ["Balance: $", user.balance.toLocaleString()],
                  }),
              ],
            }),
          systemStatus &&
              ...
              children: _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    style: { display: "flex", alignItems: "center" },
                    children: [
                      _jsx(StatusIcon, { size: 16, color: status.color }),
                      _jsx(CyberText, {
                        variant: "caption",
                  ...
                  _jsxs(CyberText, {
                    variant: "caption",
                    color: "muted",
                    children: [systemStatus.dataQuality, "%"],
                  }),
                ],
              }),
            }),
          isCompact &&
            _jsx("div", {
              ...
              children: _jsx(MegaButton, {
                variant: "ghost",
                size: "sm",
                onClick: onToggle,
                icon: _jsx(Menu, { size: 16 }),
              }),
            }),
        ],
      }),
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          ...
          (title || subtitle) &&
            _jsxs("div", {
              style: { marginLeft: leftActions ? "16px" : "0" },
              children: [
                title &&
                  _jsx(CyberText, {
                    variant: "title",
