...
import { Menu, X, TrendingUp, DollarSign, Target, Activity, BarChart3, Brain, Settings, User, } from "lucide-react";
...
const PerformanceAnalyticsDashboard = React.lazy(() => import("../analytics/PerformanceAnalyticsDashboard").then((m) => ({
    default: m.PerformanceAnalyticsDashboard,
})));
const UnifiedMoneyMaker = React.lazy(() => import("../money-maker/UnifiedMoneyMaker").then((m) => ({
    default: m.UnifiedMoneyMaker,
})));
const UnifiedStrategyEngineDisplay = React.lazy(() => import("../strategy/UnifiedStrategyEngineDisplay").then((m) => ({
    default: m.default,
})));
// ============================================================================
// COMPONENTS
