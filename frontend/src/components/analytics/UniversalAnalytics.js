...
import { TrendingUp, Brain, Activity, Maximize2, Minimize2, RefreshCw, Clock, } from "lucide-react";
...
export const UniversalAnalytics = () => {
    ...
    const renderControlPanel = () => (_jsxs(MegaCard, { variant: "glass", padding: "lg", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx(MegaButton, { variant: "primary", onClick: loadAnalyticsData, loading: isLoading, icon: _jsx(RefreshCw, { size: 16 }), children: "Refresh Data" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("input", { type: "checkbox", checked: state.isAutoRefresh, onChange: (e) => setState((prev) => ({
                                ...
                                })), className: "w-full p-2 bg-gray-800 border border-gray-600 rounded text-white", children: [_jsx("option", { value: 15000, children: "15 seconds" }), _jsx("option", { value: 30000, children: "30 seconds" }), _jsx("option", { value: 60000, children: "1 minute" }), _jsx("option", { value: 300000, children: "5 minutes" })] })] })] })] }));
    // ============================================================================
    // MAIN RENDER
    // ============================================================================
